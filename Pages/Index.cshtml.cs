...
namespace RagnarockGasolin.Pages
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            {
                new BandMember("Kim Larsen", "kim-larsen", "kim-larsen.jpg", "qrcode_kim-larsen.png"),
                ...
                new BandMember("Søren Berlev", "soeren-berlev", "soeren-berlev.jpg", "qrcode_soeren-berlev.png")
            };
        }
    }
}
